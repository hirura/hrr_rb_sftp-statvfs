RSpec.describe HrrRbSftp::Protocol::Version3::Extensions::FstatvfsAtOpensshCom do
  it "inherits Extension class" do
    expect( described_class ).to be < HrrRbSftp::Protocol::Version3::Extensions::Extension
  end

  let(:extension_name){ "fstatvfs@openssh.com" }
    ...
    let(:packet){
      {
        ...
        :"request-id"       => 1,
        :"extended-request" => "fstatvfs@openssh.com",
        :"handle"           => "handle",
      }
    }
    let(:payload){
